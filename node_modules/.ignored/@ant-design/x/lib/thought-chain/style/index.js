...
const genThoughtChainItemStatusStyle = token => {
  ...
  const colors = {
    [_Item.THOUGHT_CHAIN_ITEM_STATUS.PENDING]: token.colorPrimaryText,
    [_Item.THOUGHT_CHAIN_ITEM_STATUS.SUCCESS]: token.colorSuccessText,
    [_Item.THOUGHT_CHAIN_ITEM_STATUS.ERROR]: token.colorErrorText
  };
...
var _default = exports.default = (0, _genStyleUtils.genStyleHooks)('ThoughtChain', token => {
  ...
  return [genThoughtChainStyle(compToken), (0, _motion.genCollapseMotion)(compToken)];
});