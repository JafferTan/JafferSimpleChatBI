...
const Bubble = (props, ref) => {
  ...
  // ============================ Typing ============================
  const [typingEnabled, typingStep, typingInterval] = (0, _useTypingConfig.default)(typing);
  ...
  // ============================ Avatar ============================
  const avatarNode = /*#__PURE__*/_react.default.isValidElement(avatar) ? avatar : /*#__PURE__*/_react.default.createElement(_antd.Avatar, avatar);
