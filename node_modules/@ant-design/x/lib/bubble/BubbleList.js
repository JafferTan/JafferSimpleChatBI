...
var _useDisplayData = _interopRequireDefault(require("./hooks/useDisplayData"));
...
const BubbleList = (props, ref) => {
  ...
  const [displayData, onTypingComplete] = (0, _useDisplayData.default)(mergedData);
  ...
  return wrapCSSVar( /*#__PURE__*/React.createElement(_Bubble.BubbleContext.Provider, {
    ...
    key,
    ...bubble
  }) => /*#__PURE__*/React.createElement(_Bubble.default, (0, _extends2.default)({}, bubble, {
    key: key,
    ref: node => {
      if (node) {
