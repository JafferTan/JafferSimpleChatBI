...
const Bubble = (props, ref) => {
  ...
  // ============================ Avatar ============================
  const avatarNode = /*#__PURE__*/React.isValidElement(avatar) ? avatar : /*#__PURE__*/React.createElement(Avatar, avatar);
  ...
  if (header || footer) {
    ...
    }, header), fullContent, footer && /*#__PURE__*/React.createElement("div", {
